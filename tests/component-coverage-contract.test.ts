...
const correctnessCoverage = {
  ...
  PieChart: ["tests/charts.test.ts", "tests/browser/chart-rendering.test.tsx"],
...
const benchmarkCoverage = {
  ...
  PieChart: ["benches/tier2/public-render.bench.tsx", "benches/tier4/browser-flows.bench.tsx"],
